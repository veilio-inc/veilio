...
The current build loads its web fonts from **Google Fonts**, which discloses your IP address and User-Agent to Google when the page loads. This sets no cookies, but it is a third-party request and some deployments will need to eliminate it. The [Privacy Notice](./privacy.md) explains what it discloses and how to remove it.
